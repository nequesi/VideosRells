...
def criar_video_vertical_1080x1920():
    ...
    # Redimensiona especialista sem distorcer (encaixa na altura)
    ...
    # Redimensiona satisfatório e repete se necessário
    ...
    saida = os.path.join(caminho, "video_final_1080x1920.mp4")
...
if __name__ == "__main__": #este e top
    criar_video_vertical_1080x1920()
